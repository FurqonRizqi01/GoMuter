...
class PKL(models.Model):
    ...
    nomor_rekening = models.CharField(max_length=80, blank=True, null=True)
    ewallet_provider = models.CharField(max_length=50, blank=True, null=True)
    ewallet_number = models.CharField(max_length=50, blank=True, null=True)
